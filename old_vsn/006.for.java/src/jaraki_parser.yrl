...
%% BEGIN_FOR
for_expr -> for '(' int_t identifier '=' integer ';' identifier comp_op literal
				';' identifier inc_op  ')'  expression :
			{line('$1'), for,
				{for_init, {var_type, unwrap('$3')}, {var_name, unwrap('$4')}},
				{for_start, '$6'}, {for_end, '$10'}, {comp_op, unwrap('$9')},
				{inc_op, unwrap('$13')}, {for_body, '$15'}}.

for_no_trailing -> for '(' int_t identifier '=' integer ';'
					identifier comp_op literal ';'
					identifier inc_op  ')'  no_short_if_expr :
			{line('$1'), for,
				{for_init, {var_type, unwrap('$3')}, {var_name, unwrap('$4')}},
				{for_start, '$6'}, {for_end, '$10'}, {comp_op, unwrap('$9')},
				{inc_op, unwrap('$13')}, {for_body, '$15'}}.
